...
<PackageManagers pkg="@cloudflare/nimbus-docs" type="dlx" args="add content-concept" />
...
**Boundaries → See also.** Ending on scope is what most defines this type, and it's not our invention: Diátaxis asks explanation to weigh "alternatives and counter-examples." Stating what the concept is *not*, next to its confusable neighbors, is the cheapest way to make the model stick.
