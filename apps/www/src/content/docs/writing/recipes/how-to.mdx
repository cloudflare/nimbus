...
- **Numbered steps** are the defining structure — as the Steps component or a plain ordered list; both must read identically in the `.md` twin. If a page has no steps, question whether it's a how-to.
