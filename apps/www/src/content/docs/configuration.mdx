...
| `admonitions`        | `true`                  | Native Sätteri MDX directives → `<Aside>`; object adds `typeAliases`, `contentDirs`, and `skip`.                                                                                                                                                                                              |
...
| `mdx`                | —                       | Native Astro MDX options, including `optimize`, `gfm`, and `smartypants`.                                                                                                                                                                                                                   |
