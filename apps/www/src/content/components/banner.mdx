...
<Showcase code={`<Banner variant="tip" content="We're hiring — say hi at <a href='#'>jobs@nimbus.dev</a>." />`}>
  <div class="w-full max-w-md text-left">
    <Banner variant="tip" content="We're hiring — say hi at <a href='#'>jobs@nimbus.dev</a>." />
  </div>
</Showcase>
