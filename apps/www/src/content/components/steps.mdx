...
props:
  - name: start
    type: number
    description: "`Steps` prop. Offsets the step counter — useful for splitting long flows across page sections."
  - name: title
    type: string
    description: "`Step` prop. Semibold lead text rendered above the step body."
---
